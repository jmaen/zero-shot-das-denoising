...
The different preprocessing steps and their corresponding denoised results are visualized in Figure~\ref{fig:preprocessing}.

% TODO figure: 4x2 grid | top - inputs (noisy, filtered, median, reweighted); bottom - corresponding results
