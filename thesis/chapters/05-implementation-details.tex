...
\end{itemize}
Detailed information and exact sources for the samples used in our experiments can be found in the supplementary material.

\section{Preprocessing}

% TODO local normalization channel wise (and only for SG-DIP!)
...
% TODO correct preprocessing figure
\begin{figure}
    \centering
