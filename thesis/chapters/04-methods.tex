...
To explicitly reinforce this behavior, we propose using a schedule, inspired by DDIP, to gradually increase $\lambda$ throughout training.
...
% TODO figure: objective
\begin{figure}
    \centering
    \begin{tikzpicture}
        \draw (0,0) -- (0,1);
    \end{tikzpicture}
    \caption{SG-DIP objective.}\label{fig:SG-DIP}
\end{figure}
