...
class UNetMod1d(nn.Module):
    def __init__(self, in_ch=1, out_ch=1, hidden_ch=64, skip_ch=4, n_layers=4, label=""):
        super().__init__()
        ...
        self.out = nn.Sequential(
            nn.Conv1d(hidden_ch, out_ch, 1),
            # nn.Sigmoid()
        )

    def __str__(self):
        return f"UNetMod1d {self.label}"
